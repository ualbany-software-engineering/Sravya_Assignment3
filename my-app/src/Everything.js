...
class Everything extends Component{
    ...
    componentDidMount(props){
        axios.get(`https://newsapi.org/v2/everything?q=${this.props.Query}&pageSize=${100}&apiKey=00902fe8f9a04fceac8ac41e1ed58946`,{timeout:20000})
            .then(res => {
            this.setState({
                objs:res.data,
            });
     ...
     componentDidUpdate(prevProps){
        ...
        axios.get(`https://newsapi.org/v2/everything?q=${this.props.Query}&pageSize=${100}&apiKey=00902fe8f9a04fceac8ac41e1ed58946`)
          .then(res => {
           this.setState({
                objs:res.data,
            });
        ...
        return(
            ...
            <div >
                  {(this.state.myerror!=="Timeouterror")?
                    <div>
                <h5 className="text-center" >Search results for :{this.props.Query}</h5>
